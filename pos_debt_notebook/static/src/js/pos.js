odoo.define('pos_debt_notebook.pos', function (require) {
    ...
    models.Order = models.Order.extend({
        ...
        has_sponsored_journal: function(){
            return this.paymentlines.any(function(line){
                    return line.cashregister.journal.is_sponsored_journal;
                });
        },
        ...
        add_paymentline: function(cashregister) {
            ...
            if (!this.get_client() && (this.has_credit_product() || journal.debt) && !journal.is_sponsored_journal){
                setTimeout(function(){
            ...
            if (cashregister.journal.debt){
                ...
                this.repeat_payment(newPaymentline);
            }
            else if (cashregister.journal.type === 'cash' && cashregister.journal_id[1] === 'Cash (AUD)'){
                newPaymentline.set_amount(this.get_rounded());
                this.repeat_payment(newPaymentline);
            }
        ...
        repeat_payment : function (newPaymentline) {
            this.paymentlines.add(newPaymentline);
